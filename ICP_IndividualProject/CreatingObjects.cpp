...
Airline CreatingObjects::createAirlineObject(vector<string> airlineArray) {
        ...
        try{
            ...
            cout << "NumberFormatExceptionCaught" << endl;
            cout << "Argument used must be a number" << endl;
...
/**
 ...
 string CreatingObjects::getAirportid(const string& city, const string& country){
       string Airportcode;

    for (const auto &Object: GetObject::AirportObjects){

        if (Object.getCity() == city && Object.getCountry() == country) {

            Airportcode = Object.getIataCode();
        }
